...
const mainImage = '/assets/mig.jpg';
const thumbnails = [
  '/assets/mig1.jpg',
  '/assets/mig2.jpg',
  '/assets/mig.jpg',
  ...
  return (
    ...
    >
      <div className="relative text-center mb-20">
        <h2 className="text-6xl md:text-8xl font-extrabold text-gray-200 uppercase">MIG-Welding</h2>
        <h1 className="text-3xl md:text-4xl font-bold text-gray-800 absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2">MIG-Welding System</h1>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-20 items-start">
        ...
        >
          <h2 className="text-3xl font-semibold text-gray-800">MIG-Welding System at Sharptrax Technologies</h2>
          <p>At Sharptrax Technologies, our MIG-Welding System is designed for high speed, high-quality welding, making it ideal for industrial and manufacturing applications. Using Metal Inert Gas (MIG) welding, this system provides strong, precise, and efficient welds across various materials, including mild steel, stainless steel, and aluminum.</p>
          <p>We offer extensive range of MIG-Welding SPM for typical jobs. Various metal joints like circumferential or linear can be easily automated. Fine weld bead and repeatability for each and every job can be easily achieved. All the parameters like job rotation, weld voltage, weld current, torch position can be programmed in PLC for different kind of jobs.</p>
        </motion.div>
      </div>
    </motion.div>
  );
